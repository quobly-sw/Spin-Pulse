...
<img src="docs/source/customapi/figures/global_fig.png">
...
**`SpinPulse`** is published in ... - if it's ever useful in research please consider supporting development by citing it!

```latex
@article{vermersch2025Spinpulse,
    title={The SpinPulse library for transpilation and noise-accurate simulation of spin qubit quantum computers
},
    author={Vermersch, Beno\^it},
    journal={},
    year = {2025},
}
```
