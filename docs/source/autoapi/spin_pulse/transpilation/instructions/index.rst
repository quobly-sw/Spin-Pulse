...
.. py:class:: PulseInstruction(qubits, duration=1)
   ...
   Initializes a pulse instruction acting on the given qubits.
...
.. py:class:: GaussianRotationInstruction(name, qubits, amplitude, sign, coeff_duration, duration)
   ...
   Initializes a Gaussian rotation pulse with given parameters.
   ...
   :returns:
             ...
             The Gaussian rotation instruction is stored in the
               created object.
   :rtype: - None
   ...
   .. py:method:: from_angle(name, qubits, angle, hardware_specs)
      ...
      Builds a Gaussian pulse that performs a target rotation angle.
      ...
      :returns:
                ...
                A Gaussian pulse instruction that
                  performs the requested angle within the hardware limits.
   ...
   .. py:method:: eval(t)
      ...
      Evaluates the Gaussian pulse envelope at the given time indices.

      The envelope is defined as:
          amplitude * sign * exp( - (t - t0)^2 / (2 * sigma^2) )
...
.. py:class:: RotationInstruction(name, qubits, duration)
   ...
   Initializes a rotation instruction with a given name and duration.
   ...
   .. py:method:: from_angle(name, qubits, angle, hardware_specs)
      ...
      Constructs a rotation instruction from a target angle.
   ...
   .. py:method:: eval(t)
      ...
      Evaluates the pulse envelope at the given time indices.
   ...
   .. py:method:: to_pulse()
      ...
      Returns the full pulse envelope over the instruction duration.
   ...
   .. py:method:: to_angle()
      ...
      Computes the effective rotation angle generated by the pulse.
   ...
   .. py:method:: to_hamiltonian()
      ...
      Builds the generator Hamiltonian associated with this rotation.
      ...
      :returns: Hamiltonian matrix of size 2**n by 2**n, where n is the number of qubits.
                - ndarray: Time-dependent coefficients defined by the pulse envelope.
      :rtype: - ndarray
   ...
   .. py:method:: adjust_duration(duration)
      ...
      Rescales the pulse amplitude to match a new duration.
   ...
   .. py:method:: plot(ax=None, t_start=0, label_gates=True)
      ...
      Plots the pulse envelope as a filled region.
...
.. py:class:: SquareRotationInstruction(name, qubits, amplitude, sign, ramp_duration, duration)
   ...
   Initializes a square rotation pulse with ramps and plateau.
   ...
   .. py:method:: from_angle(name, qubits, angle, hardware_specs)
      ...
      Builds a square pulse that performs a target rotation angle.
      ...
      :returns:
                ...
                A square pulse instruction that
                  performs the requested angle within the hardware limits.
   ...
   .. py:method:: eval(t)
      ...
      Evaluates the square pulse envelope at the given time indices.
