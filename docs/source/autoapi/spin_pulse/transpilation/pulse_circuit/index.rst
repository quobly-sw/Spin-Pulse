...
.. py:class:: PulseCircuit(circ, qubits, pulse_layers, hardware_specs, exp_env = None, store_samples = False)
   ...
   .. py:method:: run_experiment(exp_env, mps_bond_dim=int(pow(2, 10)), mps_trunc_threshold=0.01)
      ...
      :param - exp_env: Noise environment from
                        ...
                        evaluation is performed.
      :type - exp_env: ExperimentalEnvironment | None
      :param - mps_bond_dim: bond dimension used for MPS simulation. Default is 2**10.
      :type - mps_bond_dim: int, optional
      :param - mps_trunc_threshold: truncation threshold used for MPS simulation. Default is 10e-3.
      :type - mps_trunc_threshold: float, optional
