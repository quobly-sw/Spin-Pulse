...
class RotationInstruction(PulseInstruction):
    ...
    Attributes:
        - name (str): Label of the generating operator, for example
          "x", "y", "z", or "Heisenberg".
        - qubits (list): List of qubits on which the rotation acts.
    ...
    def __init__(self, name, qubits, duration):
        ...
        Parameters:
            - name (str): Name of the generating operator, for example
              "x", "y", "z", or "Heisenberg".
            - qubits (list): List of qubits on which the rotation is applied.
            - duration (int): Duration of the pulse in time steps.
    ...
    def from_angle(cls, name, qubits, angle, hardware_specs):
        ...
        Returns:
            - RotationInstruction: Instance of the subclass implementing
    ...
    def to_hamiltonian(self):
        ...
        Returns:
            - ndarray: Hamiltonian matrix of size 2**n by 2**n, where n is the number of qubits.
...
class SquareRotationInstruction(RotationInstruction):
    ...
    def from_angle(cls, name, qubits, angle, hardware_specs):
        ...
        Returns:
            - SquareRotationInstruction: A square pulse instruction that
    ...
    def __str__(self):
        """Returns a readable string representation of the square pulse.
...
class GaussianRotationInstruction(RotationInstruction):
    ...
    def __init__(self, name, qubits, amplitude, sign, coeff_duration, duration):
        ...
        Returns:
            - None: The Gaussian rotation instruction is stored in the
              created object.
    ...
    def from_angle(cls, name, qubits, angle, hardware_specs):
        ...
        Returns:
            - GaussianRotationInstruction: A Gaussian pulse instruction that
              performs the requested angle within the hardware limits.
    ...
    def __str__(self):
        """Returns a readable string representation of the Gaussian pulse.
