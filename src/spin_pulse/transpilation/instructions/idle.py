...
class IdleInstruction(PulseInstruction):
    ...
    Attributes:
        ...
        - qubits (list): List of qubits on which the idle operation acts.
    ...
    def __init__(self, qubits: list, duration: int = 1):
        ...
        Parameters:
            - qubits (list): List of qubits where the idle operation is applied.
    ...
    def __str__(self):
        """Returns a readable string representation of the idle instruction.
    ...
    def to_dynamical_decoupling(self, hardware_specs: HardwareSpecs):
        ...
        Returns:
            - list: List of PulseInstruction objects implementing the chosen
