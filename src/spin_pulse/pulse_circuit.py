...
class PulseCircuit:
    ...
    def __init__(
        ...
        Parameters:
            ...
            - store_samples (bool): If True, allocate an internal dictionary
    ...
    def from_circuit(
        ...
        Parameters:
            ...
            - store_samples (bool): If True, allocate storage for time-series
    ...
    def fidelity(self, circ_ref: QuantumCircuit) -> float:
    ...
    def mean_fidelity(
        self, circ_ref: QuantumCircuit, exp_env: ExperimentalEnvironment | None
    ) -> float:
    ...
    def attach_dynamical_decoupling(self, hardware_specs: HardwareSpecs):
        ...
        if hardware_specs.dynamical_decoupling is not None:
            for layer in self.pulse_layers:
                layer.attach_dynamical_decoupling(
                    hardware_specs, mode=hardware_specs.dynamical_decoupling
                )
